...
INSERT INTO tasks (user_id, module_id, title, description, task_type, deadline, estimated_hours, grade_weight, difficulty, is_group_work, status, progress_percentage) VALUES
-- Urgent tasks
('sample-user-123', 1, 'Database Assignment 2', 'Design and implement a normalized database for an e-commerce system', 'assignment', DATE_ADD(NOW(), INTERVAL 2 DAY), 8, 15, 'hard', FALSE, 'in_progress', 40),
('sample-user-123', 2, 'Web Dev Project Submission', 'Complete responsive portfolio website with React', 'project', DATE_ADD(NOW(), INTERVAL 3 DAY), 12, 25, 'very_hard', TRUE, 'in_progress', 60),
...
('sample-user-123', 4, 'Mobile App Prototype', 'Flutter app prototype with navigation', 'assignment', DATE_ADD(NOW(), INTERVAL 6 DAY), 10, 20, 'hard', FALSE, 'in_progress', 25),
...
-- Further out
('sample-user-123', 2, 'Final Web Project', 'Full-stack web application with authentication', 'project', DATE_ADD(NOW(), INTERVAL 21 DAY), 30, 40, 'very_hard', TRUE, 'not_started', 0),
('sample-user-123', 3, 'SE Group Project Milestone 2', 'Requirements analysis and system design', 'project', DATE_ADD(NOW(), INTERVAL 18 DAY), 15, 30, 'hard', TRUE, 'in_progress', 15),

-- Overdue (for testing)
('sample-user-123', 4, 'Mobile App Tutorial', 'Complete Flutter tutorial exercises', 'assignment', DATE_SUB(NOW(), INTERVAL 1 DAY), 3, 5, 'easy', FALSE, 'overdue', 80);
