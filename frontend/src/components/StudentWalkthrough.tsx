...
const steps = [
  ...
  },
  {
    ...
    description: 'Add assignments, exams, and projects with their deadlines. Urgent work automatically moves to the top.',
    icon: ListTodo,
    accent: 'onboarding-green',
    points: ['Open Tasks', 'Add a deadline and module', 'Mark it complete when you’re done'],
  },
  {
    eyebrow: 'Step 2',
    title: 'Keep each subject organized',
    description: 'Create modules for your subjects, use the study timer to focus, and check the calendar to see all your deadlines.',
    icon: BookOpen,
    accent: 'onboarding-purple',
    points: ['Organize tasks by module', 'Start a focused study session', 'See your week at a glance'],
  },
  {
    eyebrow: 'Step 3',
    title: 'Keep group work moving',
    description: 'Create a private group, invite classmates, and make it clear who owns each task.',
    icon: UsersRound,
    accent: 'onboarding-orange',
    points: ['Classmates choose whether to join', 'Assign each task to a teammate', 'Keep progress visible to everyone'],
  },
] as const;
